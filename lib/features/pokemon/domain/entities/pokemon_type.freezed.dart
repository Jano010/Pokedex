...
class _$PokemonTypeTearOff {
  ...
  _PokemonType call({required int slot, required ApiResource type}) {
    return _PokemonType(
      slot: slot,
      type: type,
    );
...
mixin _$PokemonType {
  ...
  ApiResource get type => throw _privateConstructorUsedError;
...
abstract class $PokemonTypeCopyWith<$Res> {
  ...
  $Res call({int slot, ApiResource type});

  $ApiResourceCopyWith<$Res> get type;
}
...
class _$PokemonTypeCopyWithImpl<$Res> implements $PokemonTypeCopyWith<$Res> {
  ...
  @override
  $ApiResourceCopyWith<$Res> get type {
    return $ApiResourceCopyWith<$Res>(_value.type, (value) {
...
abstract class _PokemonType implements PokemonType {
  const factory _PokemonType({required int slot, required ApiResource type}) =
      _$_PokemonType;
